        ...
        <div id="content-wrapper" class="d-flex flex-column min-vh-100">
            <div id="content" class="flex-grow-1">
                ...
                <div class="container-fluid" style="padding-top: 100px;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <button class="btn btn-primary shadow-sm" id="btn-add-user" data-toggle="modal"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive"
                                style="max-height: 480px; overflow-y: auto; border: 1px solid #e3e6f0; border-radius: 6px;">
                                <table class="table table-bordered table-striped mb-0" id="usersTable" width="100%"
                                    cellspacing="0">
                                    <thead class="thead-light"
                                        style="position: sticky; top: 0; z-index: 2; background-color: #f8f9fc;">
                                        <tr>
                                            <th
                                                style="width: 40px; position: sticky; top: 0; background-color: #eaecf4; z-index: 3;">
                                                No.</th>
                                            <th
                                                style="position: sticky; top: 0; background-color: #eaecf4; z-index: 3;">
                                                Username</th>
                                            <th style="position: sticky; top: 0; background-color: #eaecf4; z-index: 3;"
                                                class="text-nowrap">Nama &amp; Jabatan</th>
                                            <th
                                                style="position: sticky; top: 0; background-color: #eaecf4; z-index: 3;">
                                                Status Karyawan</th>
                                            <th
                                            ...
                                            <th
                                                ...
                                                Hak Akses Modul</th>
                                            <th style="position: sticky; top: 0; background-color: #eaecf4; z-index: 3;"
                                                class="text-nowrap">Tanggal Registrasi</th>
                                            <th style="width: 220px; position: sticky; top: 0; background-color: #eaecf4; z-index: 3;"
                                                class="text-center text-nowrap">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody id="users-table-body">
                                        <tr>
                                            <td colspan="8" class="text-center py-4">Memuat data user...</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group mb-3">
                                            <label for="modal_username"
                                                class="small font-weight-bold text-gray-700">Username <span
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="modal_name" class="small font-weight-bold text-gray-700">Nama
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="modal_employment_type"
                                                class="small font-weight-bold text-gray-700">Status Karyawan <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-control" id="modal_employment_type"
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="modal_job_title"
                                                class="small font-weight-bold text-gray-700">Job Title / Jabatan</label>
                                            <input type="text" class="form-control" id="modal_job_title"
                                                name="job_title" placeholder="Masukkan Job Title" autocomplete="off">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="modal_password"
                                                class="small font-weight-bold text-gray-700">Password <span
                                                    id="pass-required-hint" class="text-danger">*</span></label>
                                            <input type="password" class="form-control" id="modal_password"
                                                name="password" placeholder="Masukkan Password"
                                                autocomplete="new-password">
                                            <small id="pass-help" class="form-text text-muted d-none">Biarkan kosong
                                                jika tidak ingin mengubah password.</small>
                                        </div>
                                        <div class="form-group mb-3" id="modal_role_container">
                                            <label for="modal_role" class="small font-weight-bold text-gray-700">Role
                                                Sistem <span class="text-danger">*</span></label>
                                            <select class="form-control" id="modal_role" name="role">
                                                <option value="head_asset_warehouse_admin">Head-Department</option>
                                                <option value="head_warehouse_admin">Head-Subdept</option>
                                                ...
                                                <option value="outsourcing">User</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group mb-2">
                                            <label class="small font-weight-bold text-gray-700">Hak Akses Modul WMS &
                                                Permissions</label>
                                            <div class="card p-3 bg-light border-0 rounded"
                                                ...
                                                <div class="d-flex align-items-center mb-2 flex-wrap" style="gap: 6px;">
                                                    <span class="badge badge-pill"
                                                        style="background-color: #d1ecf1; color: #0c5460; font-size: 0.62rem; padding: 2px 6px;"><i
                                                            class="fas fa-eye mr-1"></i>View</span>
                                                    <span class="badge badge-pill"
                                                        style="background-color: #d4edda; color: #155724; font-size: 0.62rem; padding: 2px 6px;"><i
                                                            class="fas fa-plus mr-1"></i>Add/Edit</span>
                                                    <span class="badge badge-pill"
                                                        style="background-color: #f8d7da; color: #721c24; font-size: 0.62rem; padding: 2px 6px;"><i
                                                            class="fas fa-trash mr-1"></i>Delete</span>
                                                </div>
                                                ...
                                                foreach ($sectionKeys as $secKey):
                                                    if (empty($groupedModules[$secKey]))
                                                        continue;
                                                    ...
                                                    <?php endif;
                                                    $firstSec = false; ?>
                                                    <p class="small text-muted mb-2 font-weight-bold"
                                                        style="line-height:1.3;">
                                                        <i
                                                            class="<?php echo htmlspecialchars($secInfo['icon']); ?> mr-1"></i><?php echo htmlspecialchars($secInfo['label']); ?>:
                                                    </p>
                                                    <?php foreach ($groupedModules[$secKey] as $modKey => $mod): ?>
                                                        <div class="module-perm-row mb-2"
                                                            data-module="<?php echo htmlspecialchars($modKey); ?>">
                                                            <div class="custom-control custom-checkbox d-inline-block">
                                                                <input type="checkbox"
                                                                    class="custom-control-input module-checkbox"
                                                                    id="mod_<?php echo htmlspecialchars($modKey); ?>"
                                                                    value="<?php echo htmlspecialchars($modKey); ?>">
                                                                <label
                                                                    class="custom-control-label font-weight-bold text-gray-800"
                                                                    for="mod_<?php echo htmlspecialchars($modKey); ?>">
                                                                    <i
                                                                        class="<?php echo htmlspecialchars($mod['icon'] ?? 'fas fa-cube text-primary'); ?> mr-1"></i>
                                                                    <?php echo htmlspecialchars($mod['label']); ?>
                                                                </label>
                                                            </div>
                                                            <?php if (!empty($mod['permissions'])): ?>
                                                                <div class="perm-checkboxes ml-4 mt-1"
                                                                    id="perm_<?php echo htmlspecialchars($modKey); ?>"
                                                                    style="display:none;">
                                                                    <div class="d-flex flex-wrap" style="gap: 8px;">
                                                                        <?php if (in_array('view', $mod['permissions'])): ?>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input perm-cb"
                                                                                    id="perm_<?php echo htmlspecialchars($modKey); ?>_view"
                                                                                    data-module="<?php echo htmlspecialchars($modKey); ?>"
                                                                                    data-perm="view">
                                                                                <label class="custom-control-label text-muted"
                                                                                    for="perm_<?php echo htmlspecialchars($modKey); ?>_view"
                                                                                    style="font-size:0.75rem;"><i
                                                                                        class="fas fa-eye mr-1"></i>View</label>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                        <?php if (in_array('add', $mod['permissions'])): ?>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input perm-cb"
                                                                                    id="perm_<?php echo htmlspecialchars($modKey); ?>_add"
                                                                                    data-module="<?php echo htmlspecialchars($modKey); ?>"
                                                                                    data-perm="add">
                                                                                <label class="custom-control-label text-muted"
                                                                                    for="perm_<?php echo htmlspecialchars($modKey); ?>_add"
                                                                                    style="font-size:0.75rem;"><i
                                                                                        class="fas fa-plus mr-1"></i>Add/Edit</label>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                        <?php if (in_array('delete', $mod['permissions'])): ?>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input perm-cb"
                                                                                    id="perm_<?php echo htmlspecialchars($modKey); ?>_delete"
                                                                                    data-module="<?php echo htmlspecialchars($modKey); ?>"
                                                                                    data-perm="delete">
                                                                                <label class="custom-control-label text-muted"
                                                                                    for="perm_<?php echo htmlspecialchars($modKey); ?>_delete"
                                                                                    style="font-size:0.75rem;"><i
                                                                                        class="fas fa-trash mr-1"></i>Delete</label>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php if (!empty($mod['children'])): ?>
                                                                <div id="<?php echo htmlspecialchars($modKey); ?>-sub-options"
                                                                    class="ml-4 mb-2 pl-2 sub-module-container"
                                                                    style="border-left: 2px solid #d1d3e2; display: none;">
                                                                    <p class="small text-muted mb-1" style="font-size:0.72rem;"><i
                                                                            class="fas fa-sitemap mr-1"></i>Akses Sub-Modul
                                                                        <?php echo htmlspecialchars($mod['label']); ?>:</p>
                                                                    <?php foreach ($mod['children'] as $childKey => $child): ?>
                                                                        <div class="custom-control custom-checkbox mb-1">
                                                                            <input type="checkbox"
                                                                                class="custom-control-input module-checkbox"
                                                                                id="mod_<?php echo htmlspecialchars($childKey); ?>"
                                                                                value="<?php echo htmlspecialchars($childKey); ?>"
                                                                                data-parent="<?php echo htmlspecialchars($modKey); ?>">
                                                                            <label class="custom-control-label text-gray-700"
                                                                                for="mod_<?php echo htmlspecialchars($childKey); ?>"
                                                                                style="font-size:0.8rem;">
                                                                                <i
                                                                                    class="<?php echo htmlspecialchars($child['icon'] ?? 'fas fa-circle'); ?> mr-1"></i>
                                                                                <?php echo htmlspecialchars($child['label']); ?>
                                                                            </label>
                                                                        </div>
                                                                        <?php if (!empty($child['permissions'])): ?>
                                                                            <div class="perm-checkboxes ml-4 mb-2"
                                                                                id="perm_<?php echo htmlspecialchars($childKey); ?>"
                                                                                style="display:none;">
                                                                                <div class="d-flex flex-wrap" style="gap: 8px;">
                                                                                    <?php if (in_array('view', $child['permissions'])): ?>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="checkbox"
                                                                                                class="custom-control-input perm-cb"
                                                                                                id="perm_<?php echo htmlspecialchars($childKey); ?>_view"
                                                                                                data-module="<?php echo htmlspecialchars($childKey); ?>"
                                                                                                data-perm="view">
                                                                                            <label class="custom-control-label text-muted"
                                                                                                for="perm_<?php echo htmlspecialchars($childKey); ?>_view"
                                                                                                style="font-size:0.75rem;"><i
                                                                                                    class="fas fa-eye mr-1"></i>View</label>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                    <?php if (in_array('add', $child['permissions'])): ?>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="checkbox"
                                                                                                class="custom-control-input perm-cb"
                                                                                                id="perm_<?php echo htmlspecialchars($childKey); ?>_add"
                                                                                                data-module="<?php echo htmlspecialchars($childKey); ?>"
                                                                                                data-perm="add">
                                                                                            <label class="custom-control-label text-muted"
                                                                                                for="perm_<?php echo htmlspecialchars($childKey); ?>_add"
                                                                                                style="font-size:0.75rem;"><i
                                                                                                    class="fas fa-plus mr-1"></i>Add/Edit</label>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                    <?php if (in_array('delete', $child['permissions'])): ?>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="checkbox"
                                                                                                class="custom-control-input perm-cb"
                                                                                                id="perm_<?php echo htmlspecialchars($childKey); ?>_delete"
                                                                                                data-module="<?php echo htmlspecialchars($childKey); ?>"
                                                                                                data-perm="delete">
                                                                                            <label class="custom-control-label text-muted"
                                                                                                for="perm_<?php echo htmlspecialchars($childKey); ?>_delete"
                                                                                                style="font-size:0.75rem;"><i
                                                                                                    class="fas fa-trash mr-1"></i>Delete</label>
                                                                                        </div>
                                                                                    <?php endif; ?>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    if (btnAddUser) {
                        btnAddUser.addEventListener('click', function () {
                            ...
                            document.getElementById('modal_employment_type').value = "Karyawan Tetap";
                ...
                function renderUsersTable(users) {
                    ...
                    if (users.length === 0) {
                        tbody.innerHTML = '<tr><td colspan="8" class="text-center py-4">Belum ada data user tersimpan.</td></tr>';
                        return;
                    }
                    ...
                    users.forEach(function (u, index) {
                        ...
                        if (u.role === 'superadmin') {
                            ...
                            roleBadge = '<span class="badge text-white px-2 py-1" style="background-color: #6f42c1;"><i class="fas fa-user-tie mr-1"></i>Head-Department</span>';
                        } else if (u.role === 'head_warehouse_admin') {
                            roleBadge = '<span class="badge text-white px-2 py-1" style="background-color: #6f42c1;"><i class="fas fa-user-tie mr-1"></i>Head-Subdept</span>';
                            ...
                            roleBadge = '<span class="badge px-2 py-1" style="background-color: #6c757d; color: #fff;"><i class="fas fa-user mr-1"></i>User</span>';
                        } else {
                            roleBadge = '<span class="badge badge-secondary px-2 py-1"><i class="fas fa-user mr-1"></i>Admin Warehouse</span>';
                        }

                        var empType = u.employment_type || 'Karyawan Tetap';
                        var empBadge = (empType === 'Outsourcing')
                            ? '<span class="badge badge-warning text-white px-2 py-1"><i class="fas fa-building mr-1"></i>Outsourcing</span>'
                            : '<span class="badge badge-primary px-2 py-1"><i class="fas fa-id-badge mr-1"></i>Karyawan Tetap</span>';

                        var nameAndJob = '<div class="font-weight-bold text-gray-800">' + escapeHtml(u.name) + '</div>';
                        if (u.job_title && u.job_title.trim() !== '') {
                            nameAndJob += '<div class="small text-muted" style="font-size:0.75rem;"><i class="fas fa-briefcase text-gray-400 mr-1"></i>' + escapeHtml(u.job_title) + '</div>';
                        }
                        ...
                        tr.innerHTML = '<td>' + rowNum + '</td>' +
                            ...
                            '<td class="text-nowrap">' + nameAndJob + '</td>' +
                            '<td>' + empBadge + '</td>' +
                            '<td>' + roleBadge + '</td>' +
                            '<td>' + modulesBadges + '</td>' +
                ...
                function editUser(userId) {
                    ...
                    document.getElementById('modal_employment_type').value = u.employment_type || 'Karyawan Tetap';
                    document.getElementById('modal_job_title').value = u.job_title || '';
                ...
                function saveUser() {
                    ...
                    var employmentType = document.getElementById('modal_employment_type').value;
                    var jobTitle = document.getElementById('modal_job_title').value.trim();
                    var roleSelect = document.getElementById('modal_role');
